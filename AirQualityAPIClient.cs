...
namespace APIVerve
{
    public class AirQualityAPIClient
    {
        ...
        public AirQualityAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public AirQualityAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(airqualityQueryOptions options)
        {
            try
            {
                if (_isDebug)
